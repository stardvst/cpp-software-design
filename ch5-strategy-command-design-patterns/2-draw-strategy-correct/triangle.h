...
#include <memory>
#include <utility>
#include "drawTriangleStrategy.h"
#include "point.h"
#include "shape.h"
...
{
public:
  explicit Triangle(Point p1, Point p2, Point p3, std::unique_ptr<DrawTriangleStrategy> drawer)
...
private:
  ...
  std::unique_ptr<DrawTriangleStrategy> m_drawer{};
};
